...
CASADI_SYMBOL_EXPORT int phi(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int phi_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int phi_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void phi_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int phi_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void phi_release(int mem) {
}
...
CASADI_SYMBOL_EXPORT casadi_real phi_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}
