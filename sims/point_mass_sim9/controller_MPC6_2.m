...
function [ax,ay,mpc6Input] = controller_MPC6_2(p,xg_in,yg_in,delta_x,N,mpc6Input,M,sec,ax_in,ay_in,flip,wall)
%     M = [flip 0;0 1]*M;
    scale = 1;
    left_bound = wall;
    right_bound = -1;
...
%     A = eye(6);
    ...
    A = diag([50/scale 50/scale 5/scale 5000/scale 250/scale 250/scale 100000 1000000]); % 5000000 - perc, 1000000 - safety
%     A(3,3) = 0.5;
    if sec==3
