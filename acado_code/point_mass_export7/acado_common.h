...
{
int dummy;
/** Matrix of size: 51 x 15 (row major format)
 * 
...
/** Matrix of size: 750 x 15 (row major format) */
real_t evGx[ 11250 ];

/** Matrix of size: 750 x 3 (row major format) */
real_t evGu[ 2250 ];
...
/** Matrix of size: 750 x 6 (row major format) */
real_t Q2[ 4500 ];
...
/** Matrix of size: 15 x 3 (row major format) */
real_t QN2[ 45 ];
...
/** Matrix of size: 19125 x 3 (row major format) */
real_t E[ 57375 ];
