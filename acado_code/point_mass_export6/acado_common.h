...
{
int dummy;
/** Matrix of size: 51 x 14 (row major format)
 * 
...
/** Matrix of size: 2 x 252 (row major format) */
real_t rk_diffsTemp2[ 504 ];

/** Matrix of size: 14 x 2 (row major format) */
real_t rk_diffK[ 28 ];

/** Matrix of size: 14 x 18 (row major format) */
real_t rk_diffsPrev2[ 252 ];

/** Matrix of size: 14 x 18 (row major format) */
real_t rk_diffsNew2[ 252 ];
...
/** Matrix of size: 700 x 4 (row major format) */
real_t evGu[ 2800 ];
...
/** Matrix of size: 700 x 8 (row major format) */
real_t Q2[ 5600 ];
...
/** Matrix of size: 17850 x 4 (row major format) */
real_t E[ 71400 ];
...
/** Matrix of size: 350 x 200 (row major format) */
real_t A[ 70000 ];
